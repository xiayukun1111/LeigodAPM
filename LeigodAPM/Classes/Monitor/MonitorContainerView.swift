...
protocol MonitorContainerViewDelegate: NSObjectProtocol {
...
class MonitorContainerView: UIScrollView,FPSDelegate,NetDelegate {
    ...
    init() {
        ...
        self.deviceView.configure(nameString: UIDevice.deviceType,
                                  osString: UIDevice.deviceSystemName + " " + UIDevice.deviceSystemVersion)
